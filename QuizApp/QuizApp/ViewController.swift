...
class ViewController: UIViewController, QuizProtocol, UITableViewDelegate, UITableViewDataSource, ResultViewControllerProtocol {
    ...
    override func viewDidLoad() {
        ...
        //make it an instance of the ResultViewController, take advantage of the visual customizations
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if label != nil {
            ...
            //check to see if answers exist and indexPath.row isn't out of bounds
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if resultDialog != nil {
            ...
            //present the pop-up on the main thread
            DispatchQueue.main.async {
